...
const iconStyle =
  "text-white transition duration-300 transform origin-center hover:scale-105 hover:text-orange-300 inline-flex items-center gap-4 underline underline-offset-2 h-8";
      ...
      <div className="w-full lg:w-5/6 flex flex-col lg:flex-row gap-8 items-center">
        <div className="w-full sm:w-3/4 md:w-3/5 lg:w-1/2">
          <Card>
            ...
            <div className="p-4 w-full h-full flex flex-col gap-6 text-lg items-start">
              <IconLink
